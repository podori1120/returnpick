...
function createInitialProducts(): SourcedProduct[] {
  ...
  makeProduct({
    ...
    source_url: "https://example.com/coupang/ideapad-5",
    coupang_url: "https://example.com/coupang/ideapad-5",
    affiliate_url: "https://example.com/deeplink/ideapad-5",
    source_price: 742000,
    return_price: 742000,
    new_price: 969000,
  ...
  makeProduct({
    ...
    source_url: "https://example.com/coupang/lg-qhd",
    coupang_url: "https://example.com/coupang/lg-qhd",
    affiliate_url: "https://example.com/deeplink/lg-qhd",
    source_price: 249000,
    return_price: 229000,
    new_price: 319000,
  ...
  makeProduct({
    ...
    source_url: "https://example.com/coupang/roborock",
    coupang_url: "https://example.com/coupang/roborock",
    affiliate_url: "https://example.com/deeplink/roborock",
    source_price: 689000,
    return_price: 649000,
    new_price: 849000,
  ...
  makeProduct({
    ...
    source_url: "https://example.com/coupang/galaxybook4-return",
    coupang_url: "https://example.com/coupang/galaxybook4-return",
    affiliate_url: "https://example.com/deeplink/galaxybook4-return",
    source_price: 879000,
    return_price: 859000,
    new_price: 1199000,
  ...
  makeProduct({
    ...
    source_url: "https://example.com/coupang/samsung-32-4k-return",
    coupang_url: "https://example.com/coupang/samsung-32-4k-return",
    affiliate_url: "https://example.com/deeplink/samsung-32-4k-return",
    source_price: 289000,
    return_price: 279000,
    new_price: 389000,
  ...
  makeProduct({
    ...
    source_url: "https://example.com/coupang/dyson-v12-return",
    coupang_url: "https://example.com/coupang/dyson-v12-return",
    affiliate_url: "https://example.com/deeplink/dyson-v12-return",
    source_price: 519000,
    return_price: 489000,
    new_price: 699000,
  ...
  makeProduct({
    ...
    source_url: "https://example.com/coupang/winix-air-return",
    coupang_url: "https://example.com/coupang/winix-air-return",
    affiliate_url: "https://example.com/deeplink/winix-air-return",
    source_price: 189000,
    return_price: 179000,
    new_price: 249000,
  ...
  makeProduct({
    ...
    source_url: "https://example.com/coupang/lg-dehumidifier-return",
    coupang_url: "https://example.com/coupang/lg-dehumidifier-return",
    affiliate_url: "https://example.com/deeplink/lg-dehumidifier-return",
    source_price: 399000,
    return_price: 369000,
    new_price: 489000,
...
function hydrateDemoCatalog(state: MemoryState): MemoryState {
  ...
  for (const seed of seeds) {
    ...
    if (existing.source_product_id?.startsWith("seed-")) {
      ...
      existing.affiliate_url = existing.affiliate_url ?? seed.affiliate_url;
