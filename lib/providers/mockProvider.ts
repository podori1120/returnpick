...
const fixtures: Record<Category, Array<Omit<ProviderProduct, "keyword" | "category">>> = {
  laptop: [
    ...
    },
    {
      ...
      image_url: sampleImages.laptop,
      source_url: "https://example.com/coupang/asus-tuf",
      coupang_url: "https://example.com/coupang/asus-tuf",
  ...
  cordless_vacuum: [
    {
      ...
      source_url: "https://example.com/coupang/samsung-jet",
      coupang_url: "https://example.com/coupang/samsung-jet",
      source_price: 319000,
      return_price: 299000,
      new_price: 429000,
      condition_grade: "상",
  ...
  air_purifier: [
    {
      ...
      source_url: "https://example.com/coupang/winix-air",
      coupang_url: "https://example.com/coupang/winix-air",
      source_price: 189000,
      return_price: 179000,
      new_price: 249000,
      condition_grade: "미개봉",
  ...
  dehumidifier: [
    {
      ...
      source_url: "https://example.com/coupang/lg-dehumidifier",
      coupang_url: "https://example.com/coupang/lg-dehumidifier",
      source_price: 399000,
      return_price: 369000,
      new_price: 489000,
      condition_grade: "최상",
