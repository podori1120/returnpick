...
쿠팡 파트너스 최종 승인 후 상품별 파트너스 단축 링크를 여러 개 확보했다면 `/admin`의 `Affiliate Link Intake`에서 빠르게 후보를 만들 수 있습니다. 상품명, 카테고리, `https://link.coupang.com/a/...` 링크를 입력하고, 필요하면 일반 쿠팡 상품 URL과 공개 이미지 URL을 보완하세요.
