...
async function updateMainPostWithInteractiveWidget() {
  console.log("=================================================");
  console.log("   🤖 [AI 가성비 판독 위젯] 메인 블로그 탑재 및 배포");
  console.log("=================================================\n");
  ...
  console.log(`✅ AI 판독기 위젯 탑재 메인 포스트 갱신 완료! (${updateData.url})`);
}

updateMainPostWithInteractiveWidget().catch(console.error);
