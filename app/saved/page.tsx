  ...
  return (
    <main className="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <Link className="focus-ring inline-flex rounded-lg border border-pine px-4 py-2.5 text-sm font-black text-pine hover:bg-pine hover:text-white" href="/watchlist">
          가격 기준함 열기
        </Link>
      </div>
      <SavedDealsBoard />
